...
Public Class Form1
    Dim connectionString As String = "Data Source=DESKTOP-HOPUCHT\SQLEXPRESS;Initial Catalog=BDParcial2BrendayBatseba;Integrated Security=True;"
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        'Nombres de los desarrolladores en otro MsgBox.
        Dim desarrolladores As String = "Desarrollado por: Brenda y Batseba"
        MessageBox.Show(desarrolladores, "Desarrolladores", MessageBoxButtons.OK, MessageBoxIcon.Information)

        'Brenda Marisela Viscarra Izaguirre
        'Gabriela Batseba Jaime Urias
    End Sub
End Class